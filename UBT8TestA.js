registerUBSQuestions({
  grade: "8",
  test: "A",
  prefix: "UBT",
  questions: [
      { subject: "ENGLISH", subjectMarker: true },
    { prompt: "Tawus and Maral have been learning English ______ six years.",
      ...
      { prompt: "Reduce means…",
        options: [
          ...
          "Something that is not used any longer",
          "To make something smaller"
        ],
        answer: "To make something smaller"
      },
      ...
      { prompt: "Endangered animal means…",
        options: [
          "an animal that no longer lives anywhere",
      ...
      { prompt: "She is keen ______ pursuing higher education.",
        options: ["in", "at", "on"],
        answer: "on"
      },

          { subject: "RUS DILI", subjectMarker: true },
    { prompt: "Кто автор строк: «Есть в осени первоначальной…»?",
      ...
      { prompt: "Кто научился читать в 6 лет и любил книги о путешествиях?",
        options: ["В. Распутин", "А. Грин", "М.Ю. Лермонтов"],
        answer: "А. Грин"
      },

      { prompt: "Что увидел Сафонов в шкафу учительницы?",
        options: ["стеклянную вазу", "свой портрет", "шахматы"],
        answer: "свой портрет"
      },
      ...
      { prompt: "Какую посылку отправила учительница и что он увидел впервые?",
        options: ["макароны", "яблоки", "рис"],
        answer: "рис"
      },

      { prompt: "Кем был Павел Сафонов?",
        options: ["врач", "учитель", "конструктор"],
        answer: "конструктор"
      },
      ...
      { prompt: "Сколько видов связи слов в словосочетании?",
        ...
        answer: "3"
          ...
          { subject: "JAPANESE", subjectMarker: true },
    { prompt: "*ME* - ?", options: ["ネ", "メ", "ト"], answer: "メ" },
      ...
      { prompt: "Ýene-de gelip duruň!",
        ...
        answer: "またきてください"
          ...
          { subject: "TÜRKMEN DILI", subjectMarker: true },
    { prompt: "Sözlemiň baş agzalary näme?",
      ...
      { prompt: "Söz düzümleri nädip toparlanýar?",
        options: ["Erkin söz düzümi", "Durnukly söz düzümi", "Isim we işlik söz düzümleri"],
      ...
      { prompt: "Sözlemler aýdylşyna görä nädip toparlanýar?",
        options: [
        ...
        answer: "Habar, sorag, ýüzlenme, sorag-ýüzlenme"
          ...
          { subject: "EDEBIÝAT", subjectMarker: true },
    { prompt: "“Gorkut ata” eposy nähili eser?",
        options: [
          "Meşhur edebi ýadygärlik",
          "Gahrymançylyk eseri",
          "Öwüt-ündew eseri"
        ],
        answer: "Meşhur edebi ýadygärlik"
      },

      { prompt: "“Görogly” şadessanyndan haýsy bölümler okadyňyz?",
        options: ["Kempir", "Harman däli", "Ar alyş"],
        answer: "Harman däli"
      },

      { prompt: "Wagzy-Azat eserinde perzent borjy haýsy babda?",
        options: [
          "I bap, 2 bölek",
          "II bap, 4 bölek",
          "IV bap, 3 bölek"
        ],
        answer: "II bap, 4 bölek"
      },
      ...
      { prompt: "“Mugallymyň gyzy” powestiniň baş gahrymany?",
        ...
        answer: "Dursun"
          ...
          { subject: "TÜRKMENISTAN TARÝHY", subjectMarker: true },
    { prompt: "Daňdanakan söweşi haçan boldy?",
        options: ["24.05.1040", "23.05.1940", "28.05.1040"],
        answer: "24.05.1040"
      },

      { prompt: "Malazgirt söweşi?",
      ...
      { prompt: "Ýabgu sözüň manysy?",
        options: [
          ...
          "Serkerde derejesi",
          "Ýer eýeçilik görnüşi"
        ],
        answer: "Patyşalara dakylýan at"
      },

      { prompt: "Nyzamylmülk kim?",
        options: ["Wizantiýa patyşasy", "Seljuk hökümdary", "Seljuklaryň weziri"],
        answer: "Seljuklaryň weziri"
      },

      { prompt: "Togrul beg kim?",
        options: ["Wizantiýanyň hökümdary", "Seljuklaryň hökümdary", "Gaznaly patyşasy"],
        answer: "Seljuklaryň hökümdary"
      },

          { subject: "DÜNÝÄ TARÝHY", subjectMarker: true },
    { prompt: "Binagärçilik sungatynyň görnüşleri?",
        options: [
          "Barokko, Rokoko, klassisizm",
          "Heýkeltaraşlyk, binagärçilik",
          "Zergärçilik, kulalçylyk"
        ],
        answer: "Barokko, Rokoko, klassisizm"
      },

      { prompt: "Wizantiýanyň paýtagty?",
        options: ["Anadoly", "Konstantinopol", "Afiny"],
      ...
      { prompt: "Nedir şa kim?",
        options: ["Sefewiler hökümdary", "Osman patyşasy", "Eýran şasy"],
        answer: "Eýran şasy"
      },

      { prompt: "Sipahi sözüň manysy?",
        options: ["Düzgün tertip", "Ýer eýeçilik ulgamy", "Halk häkimiýeti"],
        answer: "Ýer eýeçilik ulgamy"
      },

          { subject: "GEOGRAFIÝA", subjectMarker: true },
    { prompt: "Türkmenistanyň meýdany näçe?",
      ...
      { prompt: "Türkmenistan haýsy sagat zolaklarynda?",
        options: ["3", "4", "5"],
        answer: "5"
      },
      ...
      { prompt: "“Altyn Asyr” kölüniň I tapgyry haçan açyldy?",
      ...
      { prompt: "Toprak näme?",
        options: [
          "Ýeriň hasylly gatlagy",
          "Baýlykly gatlak",
          "Suwarymly ýer"
        ],
        answer: "Ýeriň hasylly gatlagy"
      },

      { prompt: "Türkmenistanyň ilaty?",
        options: ["5 mln+", "6 mln+", "7 mln+"],
        answer: "7 mln+"
      },

          { subject: "BIOLOGY", subjectMarker: true },
    { prompt: "Ösümlikleri öwrenýän ylym?",
        options: ["anatomiýa", "biologiýa", "botanika"],
        answer: "botanika"
      },

      { prompt: "Içýanlaryň Türkmenistanda görnüşi näçe?",
        options: ["6", "4", "8"],
        answer: "4"
      },

      { prompt: "Doly öwrülişikli mör-möjekler?",
      ...
      { prompt: "Ýapragyň daşky görnüşiniň ady?",
        options: ["plastinka", "figura", "iňňe şekilli"],
        answer: "plastinka"
      },

      { prompt: "K.I. Skryabin nämeleri öwrenipdir?",
        options: ["balyk", "gurçuk", "ýyrtyjy haýwanlar"],
        answer: "gurçuk"
      },

      { prompt: "Medeni ösümlikler nireden gelip çykýar?",
        options: ["arça", "kerkaw", "ýabany ösümlikler"],
        answer: "ýabany ösümlikler"
      },
      ...
      { prompt: "Dermanlyk ösümlikler boýunça ylym?",
        options: ["fitoterapiýa", "algologiýa", "sitoligiýa"],
        answer: "fitoterapiýa"
      },

      { prompt: "Arkadagyň ösümlikler baradaky kitaby?",
        options: ["Paýhas çeşmesi", "Türkmenistanyň dermanlyk ösümlikleri", "Mertler Watany beýgeldýär"],
        answer: "Türkmenistanyň dermanlyk ösümlikleri"
      },

          { subject: "ALGEBRA", subjectMarker: true },
    { prompt: "Aňlatmanyň bahasy?",
      ...
      { prompt: "a,b,c koeffisentlerini görkeziň: 17x−15−4=0",
      ...
      { prompt: "Kwadrat deňlemäniň kökleri?",
        ...
        answer: "3 we -…"
          ...
          { subject: "GEOMETRIÝA", subjectMarker: true },
    { prompt: "ABC üçburçlugyň burçlaryny artýan tertipde ýazyň.",
      ...
      { prompt: "Parallelogram taraplary? P=48, tapawut=4",
        ...
        answer: "10 we 14"
          ...
          { subject: "HIMIÝA", subjectMarker: true },
    { prompt: "Na₂O + H₂O → 2NaOH reaksiýasy?",
      ...
      { prompt: "Kislorod haýsy birleşmeleriň düzüminde?",
    ...
    { prompt: "Gaýnama suwuklygyň nirede bolýar?",
      ...
      { prompt: "50 kg jisim 12 m galdyrylanda? (g=10)",
      ...
      { prompt: "Işiň birligi?",
        ...
        answer: "Joul"
          ...
          { subject: "INFORMATIKA", subjectMarker: true },
    { prompt: "Lokal kompýuter tory näme?",
      ...
      { prompt: "Programmalaşdyrma dili näme?",
        options: [
          ...
          "kompýuteri dolandyrýan sözler",
          "klawiatura arkaly sözler"
        ],
        answer: "kompýutere düşnükli sözler we belgiler toplumy"
      },

      { prompt: "Operatiw ýat nämeden ybarat?",
        options: ["sanlar-harplar", "üýtgeýänler", "öýjükler"],
        answer: "öýjükler"
      },
      ...
      { prompt: "Pascal ABC dilinde (a + c) : 2",
        options: [
          "(a + () *c)/(2)",
          "(a + *c) /2",
          "(a + c)/2"
